(function ($) {
	...
	Pages.prototype.initValidatorPlugin = function () {
		$.validator && $.validator.setDefaults({
			ignore: "", showErrors: function (errorMap, errorList) {
				var $this = this;
...
(function (window) {
	...
	SelectFx.prototype.options = {
		newTab: true, stickyPlaceholder: true, container: 'body', onChange: function (el) {
			console.log(el);
