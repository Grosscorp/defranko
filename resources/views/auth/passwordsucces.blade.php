			...
			<div class="row">
					...
					Sign In to your account
						...
						<form class="" role="form" method="POST" action="{{ url('/auth/login') }}">
							...
							<div class="sign-block">
								<button type="submit" class="sing-middle-btn upper text-right">Sign in <i class="ico-sign-middle"></i></button>
					...
					<div class="h2 upper">
						or Sign In using
                                        ...
                                        <a href="/" class="sing-middle-btn upper"><i class="ico-facebook"></i> facebook</a>
                                        <a href="/" class="sing-middle-btn upper"><i class="ico-google"></i>google</a>
                        	</div>
                        </div>
