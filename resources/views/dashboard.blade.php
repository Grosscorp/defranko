...
<head>
	...
	<!-- inject:app:js-->
	<script src="/modules/dashboard/js/sidebar.js"></script>
	<script src="/app/filters/common.js"></script>
	<script src="/app/dashboard.js"></script>
	<script src="/app/components/directives.js"></script>
	<script src="/app/components/directives-form.js"></script>
	<script src="/app/components/directives-main.js"></script>
	<script src="/app/modules/dashboard/navbar/navbar.js"></script>
	<script src="/app/services/services.js"></script>
	<script src="/app/components/notify.js"></script>
	<script src="/app/modules/dashboard/home/home.js"></script>
	<script src="/app/modules/dashboard/settings/settings.js"></script>
	<script src="/app/directives/form/form.js"></script>
	<script src="/app/directives/main/main.js"></script>
	<script src="/app/modules/dashboard/users/users.js"></script>
	<script src="/app/modules/dashboard/pages/pages.js"></script>
	<script src="/js/lang.dist.js"></script>
	<!-- endinject-->

	<!-- inject:libscss:css-->
	<link rel="stylesheet" href="/modules/dashboard/plugins/pace/pace-theme-flash.css">
