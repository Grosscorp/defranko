(function() {
			...
			.state('pages.editById', {
				...
				views : {
					content: {
						...
						templateUrl:  '/app/modules/dashboard/pages/edit.html'
					}
				},
				resolve: {
			...
			.state('pages.list', {
				...
				views : {
					content: {
						...
						templateUrl:  '/app/modules/dashboard/pages/list.html'
					}
				},
				resolve: {
	...
	Pages_list.$inject = ['$scope', 'items', '$stateParams', 'HttpService', '$state', 'BreadCrumbsService'];
	function Pages_list($scope, items, $stateParams, HttpService, $state, BreadCrumbsService)
	{
