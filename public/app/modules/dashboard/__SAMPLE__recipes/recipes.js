			...
			.state('recipes.categories', {
				...
				views : {
					content: {
						...
						templateUrl:  '/app/modules/dashboard/recipes/categories.html'
					}
				}
			})
			.state('recipes.list', {
				...
				views : {
					content: {
						...
						templateUrl:  '/app/modules/dashboard/recipes/list.html'
					}
				},
				resolve: {
			...
			.state('recipes.edit', {
				...
				views : {
					content: {
						...
						templateUrl:  '/app/modules/dashboard/recipes/edit.html'
					}
				},
				resolve: {
